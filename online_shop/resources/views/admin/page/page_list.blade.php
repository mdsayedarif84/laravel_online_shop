            ...
            <form action="" method="get">
               <div class="card-header">
                  <div class="card-title">
                     <button type="button" onclick="window.location.href='{{ route("page.list") }}'" class=" btn btn-default btn-sm">Reset</button>
                  </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="#" onclick="pageDel( {{$page->id}} )" class="text-danger w-4 h-4 mr-1">
