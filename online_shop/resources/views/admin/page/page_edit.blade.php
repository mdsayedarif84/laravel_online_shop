...
<div class="content-wrapper">
      ...
      <div class="container-fluid my-2">
         <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
               <a href="{{route('page.list')}}" class="btn btn-primary">Page List</a>
            </div>
         </div>
      </div>
      <!-- /.container-fluid -->
   ...
   <section class="content">
      ...
      <div class="container-fluid">
         ...
         <form method="post" action="" name="updatePage" id="updatePage">
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="mb-3">
                           ...
                           <input type="text" readonly value="{{ $page->slug}}" name="slug" id="slug" class="form-control" placeholder="Slug">
                           <p></p>
                        </div>
                     </div>
                     <div class="col-md-12">
