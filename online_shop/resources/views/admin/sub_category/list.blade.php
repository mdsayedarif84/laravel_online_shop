            ...
            <form action="" method="get">
               <div class="card-header">
                  <div class="card-title">
                     <button type="button" onclick="window.location.href='{{ route("sub-categories.list") }}'"
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="#" onclick="subCatDel( {{$subCategory->id}} )" class="text-danger w-4 h-4 mr-1">
...
function subCatDel(id) {
   var url = "{{ route('sub-categories.destory','ID') }}";
