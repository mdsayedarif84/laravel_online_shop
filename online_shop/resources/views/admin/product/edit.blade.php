                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              <div class="mb-3">
                                 ...
                                 <textarea name="short_description" id="short_description" cols="30" rows="5" class="summernote">{{ $product->short_description }}</textarea>
                              </div>
                           </div>
                           <div class="col-md-12">
                              <div class="mb-3">
                                 <label for="description">Description</label>
                                 <textarea name="description" id="description" cols="30" rows="8" class="summernote" placeholder="Description">{{ $product->description }}</textarea>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="mb-3">
                                 <input value="{{ $product->qty }}" type="number" min="0" name="qty" id="qty" class="form-control">
                                 <p class="error"></P>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              <div class="mb-3">
                                 ...
                                 <input type="text" value="{{ $product->compare_price }}" name="compare_price" id="compare_price" class="form-control">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="mb-3">
                                 ...
                                 <input type="text" value="{{ $product->shipping_returns }}" name="shipping_returns" id="shipping_returns" class="form-control">
                                 <p class="error"></P>
                              </div>
                           </div>
                        </div>
