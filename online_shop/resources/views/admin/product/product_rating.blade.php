            ...
            <form method="get" action="">
               <div class="card-header">
                  <div class="card-title">
                     <button type="button" onclick="window.location.href='{{ route("products.productRatingList") }}'" class="btn btn-default btn-sm">Reset</button>
                  </div>
...
<script type="text/javascript">
   function changeStatus(status, id) {
      if (confirm("Are Your Sure Want To Change Status!")) {
         $.ajax({
            ...
            success: function(response) {
               ...
               window.location.href = '{{ route("products.productRatingList") }}';
            }
         });
      }
   }
