            ...
            <form action="" method="get">
               <div class="card-header">
                  <div class="card-title">
                     <button type="button" onclick="window.location.href='{{ route("brand.list") }}'"
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="#" onclick="brandDel( {{$brand->id}} )" class="text-danger w-4 h-4 mr-1">
...
function brandDel(id) {
   var url = "{{ route('brand.destory','ID') }}";
