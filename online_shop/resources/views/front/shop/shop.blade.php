                        ...
                        <div class="card-body">
                            <div class="accordion accordion-flush" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    @else
                                    <a href="{{route('front.shop',$category->slug)}}" class="nav-item nav-link {{ ($categorySlected == $category->id) ? 'text-primary' : '' }}">{{$category->name}}</a>
                                    @endif
                                    @if($category->sub_category->isNotEmpty())
                                    <div id="collapseOne-{{ $key }}" class="accordion-collapse collapse {{ ($categorySlected == $category->id) ? 'Show' : '' }}" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
