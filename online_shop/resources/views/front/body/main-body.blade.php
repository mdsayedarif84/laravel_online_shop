...
<main>
      ...
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
         ...
         <div class="carousel-inner">
            ...
            <div class="carousel-item">
               ...
               <picture>
                  <source media="(max-width: 799px)" srcset="{{asset('images/carousel-2-m.jpg')}}" />
                  <source media="(min-width: 800px)" srcset="{{asset('images/carousel-2.jpg')}}" />
            ...
            <div class="carousel-item">
               ...
               <picture>
                  <source media="(max-width: 799px)" srcset="{{asset('images/carousel-3-m.jpg')}}" />
                  <source media="(min-width: 800px)" srcset="{{asset('images/carousel-3.jpg')}}" />
                  <img src="images/carousel-2.jpg" alt="" />
               </picture>
   ...
   <section class="section-4 pt-5">
      <div class="container">
         ...
         <div class="row pb-3">
         @if($featuresProducts->isNotEmpty())
